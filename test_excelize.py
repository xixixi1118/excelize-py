...
class TestExcelize(unittest.TestCase):
    ...
    def test_stream_writer(self):
        ...
        with self.assertRaises(TypeError) as context:
            _ = excelize.coordinates_to_cell_name(1, 1, "true")
        self.assertEqual(
            str(context.exception),
            "expected type bool for argument 'is_absolute', but got str",
        )
    ...
    def test_style(self):
        ...
        self.assertEqual(str(context.exception), "sheet SheetN does not exist")
        with self.assertRaises(TypeError) as context:
            f.set_row_style("Sheet1", 1, 1, True)
        self.assertEqual(
            str(context.exception),
            "expected type int for argument 'style_id', but got bool",
        )
        ...
        with open("chart.png", "rb") as file:
            ...
            self.assertEqual(str(context.exception), "sheet SheetN does not exist")
        with self.assertRaises(TypeError) as context:
            f.set_sheet_background_from_bytes("SheetN", ".png", 1)
        self.assertEqual(
            str(context.exception),
            "expected type bytes for argument 'picture', but got int",
        )
        ...
        self.assertEqual(str(context.exception), "sheet SheetN does not exist")
        with self.assertRaises(TypeError) as context:
            f.set_row_outline_level("Sheet1", 1, True)
        self.assertEqual(
            str(context.exception),
            "expected type int for argument 'level', but got bool",
        )
        ...
        self.assertEqual(str(context.exception), "sheet SheetN does not exist")
        with self.assertRaises(TypeError) as context:
            f.set_sheet_background("Sheet1", 1)
        self.assertEqual(
            str(context.exception),
            "expected type str for argument 'picture', but got int",
        )
        ...
        with self.assertRaises(TypeError) as context:
            _ = excelize.open_reader("")
        self.assertEqual(
            str(context.exception),
            "expected type bytes for argument 'buffer', but got str",
        )
    ...
    def test_none_file_pointer(self):
        ...
        self.assertEqual(str(context.exception), expected)
        with self.assertRaises(TypeError) as context:
            f.set_workbook_props(1)
        self.assertEqual(
            str(context.exception),
            "expected type WorkbookPropsOptions for argument 'opts', but got int",
        )
        with self.assertRaises(RuntimeError) as context:
            f.ungroup_sheets()
        self.assertEqual(str(context.exception), expected)
    ...
    def test_pivot_table(self):
        ...
        table = tables[0]
        self.assertEqual(table.data_range, opts.data_range)
        self.assertEqual(table.pivot_table_range, opts.pivot_table_range)
        self.assertEqual(table.rows[0].data, opts.rows[0].data)
        self.assertEqual(table.rows[0].default_subtotal, opts.rows[0].default_subtotal)
        self.assertEqual(table.filter, opts.filter)
        self.assertEqual(table.columns, opts.columns)
        self.assertEqual(table.data, opts.data)
        self.assertEqual(table.row_grand_totals, opts.row_grand_totals)
        self.assertEqual(table.col_grand_totals, opts.col_grand_totals)
        self.assertEqual(table.show_drill, opts.show_drill)
        self.assertEqual(table.show_row_headers, opts.show_row_headers)
        self.assertEqual(table.show_col_headers, opts.show_col_headers)
        self.assertEqual(table.show_last_column, opts.show_last_column)
        with self.assertRaises(RuntimeError) as context:
    ...
    def test_cell_name_to_coordinates(self):
        ...
        with self.assertRaises(TypeError) as context:
            _ = excelize.cell_name_to_coordinates(1)
        self.assertEqual(
            str(context.exception),
            "expected type str for argument 'cell', but got int",
        )
    ...
    def test_column_name_to_number(self):
        ...
        with self.assertRaises(TypeError) as context:
            _ = excelize.column_name_to_number(1)
        self.assertEqual(
            str(context.exception),
            "expected type str for argument 'name', but got int",
        )
    ...
    def test_column_number_to_name(self):
        ...
        with self.assertRaises(TypeError) as context:
            _ = excelize.column_number_to_name("1")
        self.assertEqual(
            str(context.exception),
    ...
    def test_set_sheet_col(self):
        ...
        self.assertEqual(str(context.exception), "sheet SheetN does not exist")
        with self.assertRaises(TypeError) as context:
            f.set_sheet_dimension("Sheet1", 1)
        self.assertEqual(
            str(context.exception),
            "expected type str for argument 'range_ref', but got int",
        )
    ...
    def test_sheet_visible(self):
        ...
        with self.assertRaises(TypeError) as context:
            f.set_sheet_visible("Sheet1", False, 1)
        self.assertEqual(
            str(context.exception),
            "expected type bool for argument 'very_hidden', but got int",
        )
